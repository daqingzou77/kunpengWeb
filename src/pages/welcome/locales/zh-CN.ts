export default {
  ...
  'dashboardandanalysis.block-height': '区块高度',
  'dashboardandanalysis.certificate': '信息数量',
  'dashboardandanalysis.total-trascations': '总交易量',
  'dashboardandanalysis.active-nodes': '活跃节点',
  'dashboardandanalysis.cunzhengshu': '信息数',
  'dashboardandanalysis.transactions': '交易数',
  'dashboardandanalysis.cunzheng-trend': '信息数趋势',
  'dashboardandanalysis.trasactions-trend': '交易量趋势',
  'dashboardandanalysis.collection-point-cunzheng-ranking': '采集点信息数排名',
  'dashboardandanalysis.collection-point-trasaction-ranking': '采集点交易排名',
};
